...
<section id="Home" class="mx-auto mt-10 mb-40 max-w-7xl scroll-m-36 px-6 sm:mt-24 lg:mt-32">
	<div class="lg:grid lg:grid-cols-12 lg:gap-8">
		<div class="sm:text-center md:mx-auto md:max-w-2xl lg:col-span-6 lg:text-left">
			<h1 class=" text-4xl font-bold tracking-tight sm:text-5xl xl:text-6xl">HeroTitle</h1>
			...
			>
				...
				<a
					href="tel:7868867436"
					class="btn btn-filled-primary btn-base mt-3 w-full sm:mt-0 sm:inline-flex sm:w-auto sm:flex-shrink-0 sm:items-center"
				>
